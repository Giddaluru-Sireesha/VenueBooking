...
<p><h1 style="text-align:center;font-weight:bold;color:#00008B;font-style:Lucida Handwriting">Customers Information</h1></p>
	...
	<div class="row">
		...
		<div class="col-md-9">
			<div class="m-5">
				...
				<caption style="color:#FF7D33; font-weight:bold; text-align:center; font-size:35px">Customers List</caption>
				<thead>
				<tr>
					<th scope="col">Id</th>
