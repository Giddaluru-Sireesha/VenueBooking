...
<div class="container-fluid">
		<a class="navbar-brand" href="search">Search Venue</a>
		<a class="navbar-brand" href="view">View Status</a>
		<a class="navbar-brand" href="/project/"><button type="button" class="btn btn-danger">Logout</button></a>
	</div>
	</nav> 
<p><h1 style="text-align:center;font-weight:bold;color:yellow;font-style:Lucida Handwriting">Add Details For Customer</h1></p>
<div class="row">
<div class="col-md-1"></div>
 <div class="col-md-8">
<form class="row g-3" action="addCS" method="post" name="frm1" >
  <div class="col-md-4">
    <label for="validationDefault01" class="form-label" style="color:yellow">Customer FirstName</label>
    <input type="text" class="form-control" id="validationDefault01" name="Fname"required>
  </div>
  <div class="col-md-4">
    <label for="validationDefault01" class="form-label" style="color:yellow">Customer LastName</label>
    <input type="text" class="form-control" id="validationDefault01" name="Lname"required>
  </div>
  <div class="col-md-4">
    <label for="validationDefault01" class="form-label" style="color:yellow">Password</label>
